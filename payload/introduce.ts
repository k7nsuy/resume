...
const introduce: IIntroduce.Payload = {
  ...
  contents: [
    ...
    '현재 AI Trainer로서 대규모 언어 모델 훈련을 위한 다양한 프로그래밍 언어로 효율적이고 기능적인 코드를 작성하여 AI 모델의 성능을 향상시키기는 일을 하고 있으며, 사이드 팀 프로젝트로서 Next.js & Nest.js로 구성한 협업 관련 애플리케이션을 개발하고 있으며, DevOps를 리드하면서 AWS, Docker 및 Terraform 을 이용하여 구축한 서버 인프라를 관리 하고 있습니다.',
  ],
  sign: '유상우',
